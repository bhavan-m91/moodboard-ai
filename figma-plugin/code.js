...
figma.ui.onmessage = (msg) => __awaiter(void 0, void 0, void 0, function* () {
    if (msg.type === "import") {
        try {
            ...
            title.fills = [{ type: "SOLID", color: { r: 0.94, g: 0.93, b: 0.91 } }];
            ...
            for (const item of items) {
                ...
                try {
                    ...
                    if (item.image_result.tags && item.image_result.tags.length > 0) {
                        ...
                        tagsText.fills = [{ type: "SOLID", color: { r: 0.96, g: 0.65, b: 0.14 } }];
                    ...
                    if (captionStr) {
                        ...
                        caption.fills = [{ type: "SOLID", color: { r: 0.66, g: 0.64, b: 0.62 } }];
